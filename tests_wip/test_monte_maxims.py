...
def test_total_always_one():
    ...
    totals_ordinary = [
        calculate_from_dict(build_random_case()).total for _ in range(sims)
    ]
    totals_no_fare = [
        calculate_from_dict(build_random_case(focus="no_descendants")).total
        for _ in range(sims)
    ]
    totals_force_hawashi = [
        calculate_from_dict(build_random_case(focus="hawashi")).total
        for _ in range(sims)
    ]
