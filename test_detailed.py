...
print("Detailed heir information:")
for name, heir in zip(result._all_heir_names, result._all_heirs):
    if heir.get("shares") or heir.get("fard"):
        print(f"  {name}: shares={heir.get('shares')}, fard={heir.get('fard')}")
